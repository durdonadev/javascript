...
console.log(
    "Change all vowels in a lowercase string to uppercase - hello:",
    capitalizeVowels("hello")
);
console.log(
    "Change all vowels in a lowercase string to uppercase - WATER:",
    capitalizeVowels("WATER")
);
...
console.log(
    "Double all the vowels in the string - hello:",
    doubleVowels("hello")
);
